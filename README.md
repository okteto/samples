...
1. [React + Java Spring Boot (Maven) + MySQL](https://github.com/okteto/polling)
...
1. [Micronaut Application to raffle prizes using a google sheet as backend](https://gitlab.com/groogle/mn-raffle)
...
1. [Anonymize production data with Privacy Dynamics and use it safely in development](https://www.privacydynamics.io/post/pre-configured-development-environments-with-okteto/) 
1. [Deploy Elasticsearch 8.x on Kubernetes with Okteto](https://www.pistocop.dev/posts/deploy_es_on_okteto/)
